...
struct G_Info *
NuevaC (struct G_Info *lista, char Nombre, int ATK, int DEF, int Nivel)
{
...
struct Tablero *
slot (struct Tablero *t, char Nombre, int ATK, int DEF, int Nivel)
{
...
struct Cem *
C (struct Cem *c, char Nombre, int ATK, int DEF, int Nivel)
{
  struct Cem *C = NULL;
